...
/**
 * A searchable command palette with grouped items
 */
...
/**
 * Command palette inside a modal dialog
 */
function DialogVariantComponent() {
...
/**
 * Minimal command menu with single group
 */
